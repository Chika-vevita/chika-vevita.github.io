  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    ...
    <li class="nav-item dropdown">
      ...
      <form class="form-inline mt-2 mt-md-0">
        <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="index.php" id="navbarDropdown" role="button" data-toggle="dropdown" style="margin-right: 10px">
        <?php
            ...
            echo " ".$_SESSION["email"]."";
                ...
                header("Location:belumdaftar.php");            }
            ?>
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <form class="px-4 py-3.5">
                <center><a href="index.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Log Out</a></center>
              </form>
            </div>
      </li>
      </form>
...
<script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
      <script>window.jQuery || document.write('<script src="https://code.jquery.com/jquery-3.3.1.slim.min.js"><\/script>')</script></body>
</html>
